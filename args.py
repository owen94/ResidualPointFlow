...
def init_parse():
    ...
    parser.add_argument('--actnorm', type=eval, default=False, choices=[True, False])
    ...
    parser.add_argument('--epochs', help='Number of epochs for training', type=int, default=10000)
