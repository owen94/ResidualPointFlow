...
def init_parse():
    ...
    parser.add_argument('--init-layer', type=str, choices=['norm','tanh','none'], default='norm'),
    ...
    parser.add_argument('--fc', type=eval, default=True, choices=[False, False]) #use fc or conv1d in resblock
    ...
    parser.add_argument('--normalize_std_per_axis', type=bool, default=False)
    parser.add_argument('--random_rotate', type=bool, default=False)


    # optimizer parameters
    parser.add_argument('--optimizer', type=str, choices=['adam', 'adamax', 'rmsprop', 'sgd'], default='sgd')
    ...
    # save and eval
    parser.add_argument('--save', help='directory to save results', type=str, default='exp2')
    parser.add_argument('--val-batchsize', help='minibatch size', type=int, default=2048)
